...
export default function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to course detail or edit page
      router.push(`/dashboard/tutor/kursus-saya/${response.data.id}`);
    } catch (err: any) {
      console.error('Failed to create course:', err);
      alert(err.message || 'Gagal membuat kursus. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Isi informasi kursus Anda dengan lengkap</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Jelaskan secara detail tentang kursus ini, apa yang akan dipelajari, siapa yang cocok mengikuti kursus ini, dll."
                />
                {errors.description && (
                  <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
                    <AlertCircle className="w-4 h-4" />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-sm text-gray-500">
                  URL gambar thumbnail kursus (disarankan 1200x630 px)
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-sm text-gray-500">
                  URL video preview yang dapat dilihat sebelum mendaftar
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Tambahkan kata kunci untuk memudahkan pencarian</p>
              </div>
            </div>
